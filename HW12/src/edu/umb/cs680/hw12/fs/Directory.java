...
import edu.umb.cs680.hw12.Alphabetical;
...
public class Directory extends FSElement {
    ...
    public LinkedList<FSElement> getChildren() {
        ...
        Collections.sort(children,new Alphabetical());
        return children;
    }
    ...
    public LinkedList<Directory> getSubDirectories() {
        ...
        //for default Alphabetical sorting
        Collections.sort(subDirectories,new Alphabetical());
    ...
    public LinkedList<File> getFiles() {
        ...
        //for default Alphabetical sorting
        Collections.sort(files,new Alphabetical());
        return files;
    }
    ...
    public LinkedList<Link> getLinks() {
        ...
        //for default Alphabetical sorting
        Collections.sort(Links,new Alphabetical());
        return Links;
    }
