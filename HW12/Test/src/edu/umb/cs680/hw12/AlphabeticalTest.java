...
public class AlphabeticalTest {
    ...
    @Test
    public void alphabeticalChildrenTest(){
        ...
        List<FSElement> actual = directory.getChildren(new Alphabetical());
        assertArrayEquals(expected,actual.toArray());
    }

    @Test
    public void alphabeticalSubDirectoriesTest(){
        Directory root = fs.getRootDirs().getFirst();
        Directory test = root.getSubDirectories().get(2);
        ...
        LinkedList<Directory> actual = directory.getSubDirectories(new Alphabetical());
        assertArrayEquals(expected,actual.toArray());
    }

    @Test
    public void alphabeticalFilesTest(){
        Directory root = fs.getRootDirs().getFirst();
        Directory src = root.getSubDirectories().get(1);
        ...
        LinkedList<File> actual = src.getFiles(new Alphabetical());
        assertArrayEquals(expected,actual.toArray());
    }
